...
<template>
    <section>
        <div class="mascot">
            <img src="@/assets/images/mascot/mascot02.svg" alt="">
        </div>
        ...
        <main>
            ...
            <div class="privacy">
                <p>非常歡迎您光臨「星引力」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
                ...
                <h2>八、聯繫管道</h2>
                <p>對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請藉由以下資訊聯繫我們：</p>
                <ul>
                    <li>公司名稱： 星引力股份有限公司</li>
                    <li>地址： B612 星球 玫瑰盛開的地方</li>
                    <li>Email： stargravity@gmail.com</li>
                    <li>電話： 02-9876-5432</li>
                </ul>
            </div>
        </main>
    </section>
